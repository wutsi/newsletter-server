[![](https://github.com/wutsi/newsletter-server/actions/workflows/master.yml/badge.svg)](https://github.com/wutsi/newsletter-server/actions/workflows/master.yml)
[![](https://github.com/wutsi/newsletter-server/actions/workflows/scheduled_run.yml/badge.svg)](https://github.com/wutsi/newsletter-server/actions/workflows/scheduled_run.yml)
...
- Install
```
$ git clone git@github.com:wutsi/newsletter-server.git
```
